...
<enforcement>
Claude Code MUST NOT skip or defer verification. All new page components and helper modules MUST be verified against these rules before approval. Build-time validation of helper module exports is mandatory. Violations require architectural review and justification.
</enforcement>