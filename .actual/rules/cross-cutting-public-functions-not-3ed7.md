...
- **R-FSEC-005** SHOULD: Use established utility libraries (gray-matter, lodash) for file parsing and data transformation to reduce custom implementation risk.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of these rules. Violations block merge and trigger security team notification. Exceptions require documented performance benchmarks or technical justification approved by security team and tech lead.
</enforcement>