...
<enforcement>
Claude Code MUST NOT skip or defer verification. All rules must be checked during code review and build-time validation. Violations must be flagged in pull requests and require architecture review for exceptions.
</enforcement>