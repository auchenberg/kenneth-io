...
<enforcement>
Claude Code MUST NOT skip or defer verification of these rules. All API routes generating dynamic images in edge runtime environments MUST comply with R-FONT-001 through R-FONT-005 before code review approval.
</enforcement>