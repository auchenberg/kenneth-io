...
These rules are ALWAYS ACTIVE for browser automation scripts, screenshot generation utilities, and DOM manipulation code that uses Playwright for programmatic browser control and visual asset generation.
