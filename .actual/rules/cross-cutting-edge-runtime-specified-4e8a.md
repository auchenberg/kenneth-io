...
- **R-NEXTJS-002** MUST: All page components in the pages/ directory MUST use Next.js file-based routing conventions.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All verify commands MUST pass before accepting new page components or API routes. Code review MUST check for Next.js pattern compliance. CI pipeline MUST fail if verify commands detect missing Next.js conventions in pages/ directory.
</enforcement>