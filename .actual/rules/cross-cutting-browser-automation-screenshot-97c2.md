...
<enforcement>
Claude Code MUST NOT skip or defer verification. All new screenshot generation scripts and browser automation code must be validated against these rules before approval.
</enforcement>