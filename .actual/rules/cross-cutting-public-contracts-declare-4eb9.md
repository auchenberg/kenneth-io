...
<enforcement>
Claude Code MUST NOT skip or defer verification of these rules during code review and pull request analysis. All violations MUST be flagged with specific rule IDs and remediation guidance.
</enforcement>