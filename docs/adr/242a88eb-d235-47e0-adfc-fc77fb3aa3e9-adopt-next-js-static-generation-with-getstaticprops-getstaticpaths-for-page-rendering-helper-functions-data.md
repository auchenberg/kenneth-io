...
1. SHOULD: Helper functions for data fetching (getTravelGuides, getBucketList) SHOULD be isolated in separate modules under helpers/ directory

## Policy Block

- SHOULD Helper functions for data fetching (getTravelGuides, getBucketList) SHOULD be isolated in separate modules under helpers/ directory
