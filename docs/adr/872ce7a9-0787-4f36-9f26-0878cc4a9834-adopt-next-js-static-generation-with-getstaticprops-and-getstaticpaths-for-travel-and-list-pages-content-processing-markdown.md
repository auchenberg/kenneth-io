...
1. SHOULD: Content processing with markdown-it SHOULD occur within getStaticProps to minimize client-side computation

## Policy Block

- SHOULD Content processing with markdown-it SHOULD occur within getStaticProps to minimize client-side computation
