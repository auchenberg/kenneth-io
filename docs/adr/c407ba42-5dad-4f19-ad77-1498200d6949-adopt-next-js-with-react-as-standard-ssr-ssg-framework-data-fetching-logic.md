...
1. SHOULD: Data fetching logic SHOULD be separated into helper modules rather than embedded directly in page components

## Policy Block

- SHOULD Data fetching logic SHOULD be separated into helper modules rather than embedded directly in page components
