...
1. SHOULD: Frontmatter parsing SHOULD use the 'gray-matter' library for consistent YAML/Markdown processing

## Policy Block

- SHOULD Frontmatter parsing SHOULD use the 'gray-matter' library for consistent YAML/Markdown processing
