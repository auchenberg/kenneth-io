...
1. MUST: Page components in the pages/ directory MUST use React as the rendering library for public-facing content

## Policy Block

- MUST Page components in the pages/ directory MUST use React as the rendering library for public-facing content
