...
1. SHOULD: API routes SHOULD accept query parameters (e.g., 'title') via searchParams.get() to customize generated content

## Policy Block

- SHOULD API routes SHOULD accept query parameters (e.g., 'title') via searchParams.get() to customize generated content
