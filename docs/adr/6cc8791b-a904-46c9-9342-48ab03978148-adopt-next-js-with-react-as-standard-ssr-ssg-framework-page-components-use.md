...
1. MUST: All page components MUST use Next.js as the primary framework for rendering and routing

## Policy Block

- MUST All page components MUST use Next.js as the primary framework for rendering and routing
