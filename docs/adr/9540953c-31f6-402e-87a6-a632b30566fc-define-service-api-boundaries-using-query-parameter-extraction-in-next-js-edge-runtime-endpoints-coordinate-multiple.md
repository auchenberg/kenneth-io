...
1. MAY: API endpoints MAY coordinate multiple external resource fetches within the same service boundary

## Policy Block

- MAY API endpoints MAY coordinate multiple external resource fetches within the same service boundary
