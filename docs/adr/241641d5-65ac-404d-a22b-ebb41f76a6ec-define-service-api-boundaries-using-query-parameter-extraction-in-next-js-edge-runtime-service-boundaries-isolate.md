...
1. MUST: Service boundaries MUST isolate external resource fetching using fetch() with import.meta.url-based URL construction

## Policy Block

- MUST Service boundaries MUST isolate external resource fetching using fetch() with import.meta.url-based URL construction
