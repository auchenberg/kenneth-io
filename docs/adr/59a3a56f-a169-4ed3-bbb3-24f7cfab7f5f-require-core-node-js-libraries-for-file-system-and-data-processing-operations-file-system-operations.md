...
1. MUST: File system operations MUST use Node.js core 'fs' and 'path' modules for reading and manipulating file paths

## Policy Block

- MUST File system operations MUST use Node.js core 'fs' and 'path' modules for reading and manipulating file paths
