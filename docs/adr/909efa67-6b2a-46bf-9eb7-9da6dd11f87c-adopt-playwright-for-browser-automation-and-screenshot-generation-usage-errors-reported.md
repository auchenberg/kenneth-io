...
1. MUST: Usage errors MUST be reported via console.error with example invocations

## Policy Block

- MUST Usage errors MUST be reported via console.error with example invocations
