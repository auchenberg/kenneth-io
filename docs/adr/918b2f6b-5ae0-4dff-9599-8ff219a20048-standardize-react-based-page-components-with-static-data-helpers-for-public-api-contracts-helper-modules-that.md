...
1. MUST: Helper modules that read file-based content MUST use Node.js core modules (fs, path) and gray-matter for frontmatter parsing

## Policy Block

- MUST Helper modules that read file-based content MUST use Node.js core modules (fs, path) and gray-matter for frontmatter parsing
