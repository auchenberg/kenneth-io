...
1. MAY: Helper modules MAY use lodash for data manipulation utilities when processing content collections

## Policy Block

- MAY Helper modules MAY use lodash for data manipulation utilities when processing content collections
