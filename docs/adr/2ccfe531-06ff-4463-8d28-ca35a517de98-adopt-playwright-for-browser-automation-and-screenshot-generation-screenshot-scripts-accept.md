...
1. MUST: Screenshot scripts MUST accept post slug as a required command-line argument and optional output path

## Policy Block

- MUST Screenshot scripts MUST accept post slug as a required command-line argument and optional output path
