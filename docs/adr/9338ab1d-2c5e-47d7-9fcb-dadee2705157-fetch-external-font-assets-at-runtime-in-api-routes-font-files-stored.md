...
1. MUST: Font files MUST be stored in the /public/fonts directory to be accessible via URL-based fetching

## Policy Block

- MUST Font files MUST be stored in the /public/fonts directory to be accessible via URL-based fetching
