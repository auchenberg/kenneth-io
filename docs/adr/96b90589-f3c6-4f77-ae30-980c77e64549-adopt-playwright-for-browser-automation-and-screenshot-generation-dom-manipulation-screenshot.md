...
1. MUST: DOM manipulation for screenshot preparation MUST be performed via page.evaluate() to execute JavaScript in the browser context

## Policy Block

- MUST DOM manipulation for screenshot preparation MUST be performed via page.evaluate() to execute JavaScript in the browser context
