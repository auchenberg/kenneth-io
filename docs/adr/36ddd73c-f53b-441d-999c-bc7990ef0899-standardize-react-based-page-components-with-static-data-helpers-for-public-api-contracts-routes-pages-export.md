...
1. MUST: API routes in pages/api/ MUST export handler functions or named HTTP method functions (GET, POST) as public contracts

## Policy Block

- MUST API routes in pages/api/ MUST export handler functions or named HTTP method functions (GET, POST) as public contracts
