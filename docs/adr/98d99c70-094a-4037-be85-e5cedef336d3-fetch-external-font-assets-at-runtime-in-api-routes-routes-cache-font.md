...
1. MAY: API routes MAY cache font assets in memory after initial fetch to reduce repeated network calls

## Policy Block

- MAY API routes MAY cache font assets in memory after initial fetch to reduce repeated network calls
