...
1. MUST: Dynamic route pages with [city] parameter MUST implement getStaticPaths to define all valid city paths for static generation

## Policy Block

- MUST Dynamic route pages with [city] parameter MUST implement getStaticPaths to define all valid city paths for static generation
