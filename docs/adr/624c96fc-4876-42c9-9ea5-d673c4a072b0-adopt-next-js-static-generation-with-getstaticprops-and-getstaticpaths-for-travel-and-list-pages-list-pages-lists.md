...
1. MUST: List pages (pages/lists.js) MUST use getStaticProps to fetch bucket list data at build time

## Policy Block

- MUST List pages (pages/lists.js) MUST use getStaticProps to fetch bucket list data at build time
