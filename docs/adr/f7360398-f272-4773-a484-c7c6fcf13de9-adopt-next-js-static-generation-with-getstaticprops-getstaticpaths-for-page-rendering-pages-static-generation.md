...
1. MUST: Pages using static generation MUST import React and utilize Next.js Link component for client-side navigation

## Policy Block

- MUST Pages using static generation MUST import React and utilize Next.js Link component for client-side navigation
