...
1. MAY: Pages MAY use markdown-it or similar libraries for content transformation within getStaticProps

## Policy Block

- MAY Pages MAY use markdown-it or similar libraries for content transformation within getStaticProps
