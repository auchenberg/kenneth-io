...
1. SHOULD: Layout components SHOULD be extracted to components/ directory and reused across statically generated pages

## Policy Block

- SHOULD Layout components SHOULD be extracted to components/ directory and reused across statically generated pages
