...
1. MAY: Pages MAY use searchParams or query parameters to customize generated content, as demonstrated in the Open Graph image generation API route

## Policy Block

- MAY Pages MAY use searchParams or query parameters to customize generated content, as demonstrated in the Open Graph image generation API route
