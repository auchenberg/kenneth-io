...
1. MUST: Font asset URLs MUST be constructed using new URL() with import.meta.url as the base for proper resolution

## Policy Block

- MUST Font asset URLs MUST be constructed using new URL() with import.meta.url as the base for proper resolution
