...
1. MUST_NOT: Public API functions MUST NOT pass unsanitized JSON.parse output directly to downstream consumers without validation

## Policy Block

- MUST_NOT Public API functions MUST NOT pass unsanitized JSON.parse output directly to downstream consumers without validation
