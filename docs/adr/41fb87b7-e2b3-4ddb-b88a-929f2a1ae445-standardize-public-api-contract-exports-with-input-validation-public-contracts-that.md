...
1. MUST: All public API contracts that parse JSON from external sources MUST validate input structure and content before processing

## Policy Block

- MUST All public API contracts that parse JSON from external sources MUST validate input structure and content before processing
