...
1. SHOULD: Dynamic image generation endpoints SHOULD use the GET method with runtime='edge' for optimal performance

## Policy Block

- SHOULD Dynamic image generation endpoints SHOULD use the GET method with runtime='edge' for optimal performance
