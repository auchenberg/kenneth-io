...
1. MUST: React MUST be used as the UI library for all component implementations

## Policy Block

- MUST React MUST be used as the UI library for all component implementations
