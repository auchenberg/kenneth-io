...
1. SHOULD: Page components requiring static data SHOULD use Next.js getStaticProps or getStaticPaths functions to fetch data at build time

## Policy Block

- SHOULD Page components requiring static data SHOULD use Next.js getStaticProps or getStaticPaths functions to fetch data at build time
