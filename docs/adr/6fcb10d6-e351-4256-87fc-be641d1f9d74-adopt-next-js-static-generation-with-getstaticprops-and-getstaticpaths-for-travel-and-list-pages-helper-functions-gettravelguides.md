...
1. SHOULD: Helper functions (getTravelGuides, getBucketList) SHOULD be organized in a dedicated helpers directory and imported by getStaticProps functions

## Policy Block

- SHOULD Helper functions (getTravelGuides, getBucketList) SHOULD be organized in a dedicated helpers directory and imported by getStaticProps functions
