...
1. MUST: Page components that require data fetching at build time MUST export a getStaticProps function that returns props for the page component

## Policy Block

- MUST Page components that require data fetching at build time MUST export a getStaticProps function that returns props for the page component
