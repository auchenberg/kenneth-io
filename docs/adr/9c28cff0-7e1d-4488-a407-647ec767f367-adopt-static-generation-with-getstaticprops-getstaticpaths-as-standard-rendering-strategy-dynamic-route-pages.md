...
1. MUST: Dynamic route pages that require static generation MUST export a getStaticPaths function to specify which paths should be pre-rendered at build time

## Policy Block

- MUST Dynamic route pages that require static generation MUST export a getStaticPaths function to specify which paths should be pre-rendered at build time
