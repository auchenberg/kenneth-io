...
1. MUST: Pages that render content-driven routes MUST export getStaticProps to enable static generation at build time

## Policy Block

- MUST Pages that render content-driven routes MUST export getStaticProps to enable static generation at build time
