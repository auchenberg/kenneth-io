...
1. SHOULD: Components that render markdown content SHOULD use markdown-it for HTML transformation

## Policy Block

- SHOULD Components that render markdown content SHOULD use markdown-it for HTML transformation
