...
1. MUST: API routes MUST be implemented in the pages/api directory following Next.js conventions

## Policy Block

- MUST API routes MUST be implemented in the pages/api directory following Next.js conventions
