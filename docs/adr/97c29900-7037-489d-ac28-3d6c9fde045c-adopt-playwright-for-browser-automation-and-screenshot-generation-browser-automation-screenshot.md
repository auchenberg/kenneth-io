...
1. MUST: Browser automation for screenshot generation MUST use Playwright as the core automation library

## Policy Block

- MUST Browser automation for screenshot generation MUST use Playwright as the core automation library
