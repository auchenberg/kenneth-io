...
**Extrapolating a bit here, these structural problems can be applied to many shared properties within products and platforms, such as Dashboard UIs, mobile apps, platform APIs, developer experience, and even customer onboarding. They all suffer from the same curse of being the lowest common denominator,and the tragedy of the commons.**

**So the next time you experience some of these challenges, take a step back and think about the structural incentives, maybe you can change them?**
